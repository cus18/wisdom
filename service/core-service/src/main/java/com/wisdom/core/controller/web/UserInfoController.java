...
public class UserInfoController {
     ...
     * @return
     */
    @RequestMapping(value = "deleteLaoyouUserByOpenId", method = {RequestMethod.POST, RequestMethod.GET})
    public ResponseDTO deleteLaoyouUserByOpenId(@RequestParam String openid) throws Exception {
        userService.deleteUserOpenIdInfo(openid);
        ResponseDTO responseDTO = new ResponseDTO();
