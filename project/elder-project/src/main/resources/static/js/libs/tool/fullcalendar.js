...
$.extend(DayGrid.prototype, {
	...
	// isRigid determins whether the individual rows should ignore the contents and be a com.wisdom.common.constant height.
...
$.extend(DayGrid.prototype, {
	...
	// Assumes the row is "rigid" (maintains a com.wisdom.common.constant height regardless of what is inside).
...
$.extend(BasicView.prototype, {
	...
	// Determines whether each row should have a com.wisdom.common.constant height
	...
	setHeight: function(totalHeight, isAuto) {
		...
		// is the event limit a com.wisdom.common.constant level number?
