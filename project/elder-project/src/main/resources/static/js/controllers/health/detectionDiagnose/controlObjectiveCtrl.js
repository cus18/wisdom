...
angular.module('controllers',[]).controller('controlObjectiveCtrl',
    ['$scope','$rootScope','$interval','$stateParams','$state','ControlTarget','GetControlTarget','ElderUtil',
        function ($scope,$rootScope,$interval,$stateParams,$state,ControlTarget,GetControlTarget,ElderUtil) {
